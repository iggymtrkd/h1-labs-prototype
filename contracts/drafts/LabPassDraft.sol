...
// DRAFT: LabPass ERC-721 (soulbound by default)
...
contract LabPassDraft is IERC721 {
  ...
  function setLevel(uint256 tokenId, uint8 level, uint8 slots) external {
    // draft: no access control
