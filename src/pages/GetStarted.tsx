    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-6">
      <div className="max-w-4xl w-full space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-muted-foreground text-lg">Choose your path to explore the protocol on Testnet</p>
        </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Simple test of onchain flow for Base Batches #2
                </p>
              </div>
          ...
          <Card className="p-8 bg-gradient-card border-secondary/20 hover:border-secondary/40 transition-all cursor-pointer group" onClick={() => navigate('/dashboard')}>
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  In-progress version of the future H1 platform
                </p>
              </div>
              <Button className="w-full" variant="outline">
                Go to Dashboard
