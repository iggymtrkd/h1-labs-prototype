  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="flex items-center justify-center p-2 m-2 rounded-lg hover:bg-muted transition-colors"
      >
      ...
      {!collapsed && labsBalance && (
        <div className="mx-4 mb-4 px-4 py-3 bg-gradient-card border border-border rounded-lg">
